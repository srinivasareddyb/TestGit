		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SupplierDemo",
									"targetURL": "#SupplierDemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SupplierDemo-display": {
								"semanticObject": "SupplierDemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=open.sap.com.opensap",
									"url": sap.ui.require.toUrl("open/sap/com/opensap")
								}
							}
						}
					}
